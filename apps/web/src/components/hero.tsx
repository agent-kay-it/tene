    ...
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center px-6 pt-14">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <div className="group flex items-center gap-3 rounded-lg border border-border bg-surface px-5 py-3 font-mono text-sm transition-colors hover:border-accent/50">
          ...
          <a
            ...
            className="flex items-center gap-2 rounded-lg border border-border px-5 py-3 text-sm font-medium transition-colors hover:bg-surface"
          >
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-muted">
